...
class BuildingsReviewPageNotStudent extends StatefulWidget {
  ...
  @override
  State<BuildingsReviewPageNotStudent> createState() =>
      _BuildingsReviewPageNotStudentState();
}

class _BuildingsReviewPageNotStudentState
    extends State<BuildingsReviewPageNotStudent> {
  //grab user
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "이용자의 개인정보를 존중하기 위해 개인정보 수집 및 이용 동의서, 개인정보처리방침, 서비스이용약관을 개정했습니다."
                      "\n아래의 개인정보 수집 및 이용 동의서, 개인정보처리방침, 서비스이용약관, 만14세 이상 확인 동의서를 모두 확인하신 후, 동의 및 미동의 의사를 밝혀주세요",
                    ...
                    const Text(
                      "*모든 이용자는 개인정보 수집 및 이용, 서비스이용약관, 개인정보처리방침에 동의하지 않을 권리가 있으며, 거부할 경우 서비스 이용이 제한됩니다.",
                      style: TextStyle(fontSize: 14),
                    ),
                    const Text(
                      "*개정약관의 적용일자(2024.01.01)까지 회원이 거부 의사를 표시하지 아니할 경우 약관의 개정에 동의한 것으로 간주합니다.",
                      style: TextStyle(fontSize: 14),
                    ),
                    const SizedBox(
                      height: 10,
                        ...
                        onPressed: () async {
                          ...
                          if (consentGiven && privacyConsentGiven) {
                            ...
                            showDialog(
                                ...
                                builder: (context) => const AlertDialog(
                                      content: Text(
                                          "이용자는 위의 약관에 동의하지 않을 권리가 있으며, 거부할 경우 서비스 이용이 제한됩니다."),
                                    ));
                          }
                        },
                        child: const Text("동의")),
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            const Text(
              "1. https://lespaceapp.blogspot.com/  - 메뉴 아이콘 - 이메일: 대학 이메일",
              style: TextStyle(fontSize: 18, color: Colors.black),
            ),
            const Text("2.  2dkroom@gmail.com - 요청 이메일 작성하기",
                style: TextStyle(fontSize: 18, color: Colors.black)),
            const SizedBox(
              height: 20,
            ),
            ElevatedButton(
                ...
                style: ButtonStyle(
                    backgroundColor:
                        WidgetStateProperty.all(const Color(0xffc2d3e5))),
                child: const Padding(
