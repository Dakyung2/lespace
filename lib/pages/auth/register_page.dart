                    ...
                    TextButton(
                        onPressed: () async {
                          ...
                          if (consentGiven && privacyConsentGiven) {
                            ...
                            showDialog(
                                ...
                                builder: (context) => const AlertDialog(
                                      content: Text(
                                        "이용자는 위의 약관에 동의하지 않을 권리가 있으며, 거부할 경우 회원가입이 불가합니다.",
                                        style: TextStyle(
                                            fontSize: 16,
                        ...
                        style: ButtonStyle(
                          backgroundColor: WidgetStateProperty.all(
                            const Color.fromARGB(223, 0, 114, 228),
                          ),
                        ),
                        child: const Text(
                          "완료",
            ...
            child: Column(
              ...
              children: [
                ...
                const Icon(Icons.person_add_alt_1_rounded,
                    size: 80, color: Color(0xffbbceee)),
                  ...
                  child: ElevatedButton(
                      style: ButtonStyle(
                        overlayColor: WidgetStateProperty.all(
                            const Color.fromARGB(255, 182, 203, 240)),
                        backgroundColor:
                            WidgetStateProperty.all(const Color(0xffbbceee)),
                      ),
                      onPressed: () {
                        showConsentDialog();
                      },
                ...
                const SizedBox(
                  ...
                  child: IframeView(
                      source:
                          "https://ads-partners.coupang.com/widgets.html?id=748208&template=banner&trackingCode=AF7078222&subId=&width=320&height=50"),
                )
              ],
            ),
          ),
